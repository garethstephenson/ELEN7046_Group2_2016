  ...
  This table provides additional information to supplement the Use Case diagram.
   ...
   \subsection{Acquire Twitter Data}
	...
	\begin{thebibliography}{99} % Bibliography - this is intentionally simple in this template
		...
		\bibitem 1 IBM Rational Unified Process, Best Practices for Software Development Teams.
	...
	\subsection{Appendix A: Individual Time-Sheet}
		...
		\begin{figure}[H] % Example image
			\center{\includegraphics[width=1.17\linewidth]{Time-Sid}}
	...
	\subsubsection{Inception Phase}
			...
			\begin{figure}[H] % Example image
				\center{\includegraphics[width=1.17\linewidth]{Inception}}
				\caption{RUP Tailoring - Inception Phase}
				\label{fig:speciation}
			\end{figure}
	...
	\begin{figure}[H] % Example image
		\center{\includegraphics[width=1.17\linewidth]{Elaboration}}
	...
	\subsubsection{Construction}
		...
		\begin{figure}[H] % Example image
			\center{\includegraphics[width=1.17\linewidth]{Construction}}
	...
	\subsubsection{Transition}
			...
			\begin{figure}[H] % Example image
				\center{\includegraphics[width=1.17\linewidth]{Transition}}
	...
	\subsection{Appendix D: Key Solution Sequence Diagram}
		...
		\begin{figure}[H] % Example image
			\center{\includegraphics[width=1.15\linewidth]{TwitterInt}}
